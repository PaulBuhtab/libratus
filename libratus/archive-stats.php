		...
		<div class="bar">
			<div class="inner">
				...
				<div class="pad" id="breadcrumb">
					...
					<a href="<?php echo getCustomPageURL('archive'); ?>"><?php echo gettext_th("Archive", "libratus"); ?></a>&nbsp;/
					<?php echo $stat_title; ?>
				</div>
			</div>
		</div>
			...
			<div class="inner">
				<div class="gallery pad">
					...
					<div class="gallery-thumbs">
						...
						echo '<br /><p class="pad">'.gettext_th("Sorry, no statistical page to show...", "libratus").'</p>'; 
						} ?>
					</div>
